...
type LastCheckInfo struct {
	...
	Syskernel []Syskernel         `toml:"syskernel"`
	Dns       Dns                 `toml:"dns"`
}
...
type AutoGenerated struct {
	Kernel []CtlKernel `toml:"kernel"`
	VM     []CtlVM     `toml:"vm"`
	Net    []CtlNet    `toml:"net"`
	Fs     []CtlFs     `toml:"fs"`
	Abi    []CtlAbi    `toml:"abi"`
	Crypto []CtlCrypto `toml:"crypto"`
	Sunrpc []CtlSunrpc `toml:"sunrpc"`
	User   []CtlUser   `toml:"user"`
}
...
type CtlCrypto struct {
	State int    `toml:"state,omitempty"`
	Name  string `toml:"name,omitempty"`
	Value string `toml:"value,omitempty"`
}
type CtlSunrpc struct {
	State int    `toml:"state,omitempty"`
	Name  string `toml:"name,omitempty"`
	Value string `toml:"value,omitempty"`
}
...
// GetSysKernel
func (l *LastCheckInfo) GetSysKernel() []Syskernel {
	return l.Syskernel
}

// GetDns
func (l *LastCheckInfo) GetDNS() *Dns {
	return &l.Dns
}
